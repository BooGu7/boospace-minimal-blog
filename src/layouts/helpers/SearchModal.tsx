    ...
    <div id="searchModal" className="search-modal">
      ...
      <div className="search-wrapper">
        <div className="search-wrapper-header">
          ...
          >
            <span className="sr-only">Tìm kiếm Icon</span>
            {searchString ? (
              <svg
        ...
        <div className="search-wrapper-footer">
          ...
          {searchString && (
            <span>
              <strong>{searchResult.length} </strong> kết quả tìm kiếm - trong{" "}
              <strong>{totalTime} </strong> giây
            </span>
          )}
          <span>
            <kbd>ESC</kbd> để tắt
